...
/*!**************************************!*\
  ...
  \**************************************/
(function ($) {
  var $notice_container = $(".niveau-admin-big-notice--container");
  ...
  function disableNotice() {
    ...
    $notice_container.closest(".niveau-admin-big-notice").find("button.notice-dismiss").click();
  }

  function toggleProcessing(value) {
    $(window).on("beforeunload.niveau-admin-big-notice", function () {
      return true;
    });

    if (value) {
      $(".niveau-admin-big-notice").addClass("processing");
      $(".niveau-admin-big-notice .action-buttons").fadeOut();
    } else {
      $(".niveau-admin-big-notice").removeClass("processing");
    }
  }
  ...
  function installBuilder(callback) {
    ...
    $.get(builderStatusData.install_url).done(function () {
      ...
      $(window).off("beforeunload.niveau-admin-big-notice");
    });
  }
  ...
  $notice_container.closest('.niveau-admin-big-notice').on("click", ".niveau-notice-dont-show-container", disableNotice);
  ...
  window.niveau_admin.showOverlay = showOverlay;
})(jQuery);
/******/ })()
;
