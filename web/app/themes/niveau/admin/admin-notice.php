...
<div class="niveau-notice-dont-show-container">
    <button class="button-link niveau-dont-show-notice">
        <?php Translations::escHtmlE( 'dont_show_anymore' ); ?>
    </button>
</div>

<div class="niveau-admin-notice-spacer">
    <div class="niveau-admin-big-notice--container">
        <div class="content-holder">
            <div class="messages-area">
                <div class="title-holder">
                    <h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', niveau_theme()->getName() ); ?></h1>
                    <p><?php Translations::escHtmlE( 'theme_description', niveau_theme()->getName() ); ?></p>
                </div>

                <ul>
                    <li>
                        <img src="<?php echo niveau_theme()->getListMarkerUrl()?>" alt="">
